...
describe("compagnyAccount", async () => {
  describe("[GET] compagnyAccount", () => {
    it("Doit répondre avec un code `200` avec la liste des comptes entreprise existantes", async () => {
      ...
      // Faire une requête GET à /compagnyAccount
